...
RUN \
  apt-get update && \
  apt-get install -y ruby flex bison gperf python python-serial build-essential gcc clang git libssl-dev autoconf libtool cmake doxygen pkg-config unzip wget
WORKDIR /usr/esp
