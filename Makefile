...
CPPFLAGS ?= $(INC_FLAGS) -DBUILD_NUMBER=$(BUILD_NUMBER) -MMD -Wall -Wextra -Wno-error=maybe-uninitialized -Wno-error -Wno-error=type-limits -Wno-unused-variable -Wno-error=cpp -Wno-unused-function
CFLAGS += -g -O0
